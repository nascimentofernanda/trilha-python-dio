...
# que indica o número de casos de teste. Em cada uma das T linhas a seguir vêm dois inteiros N e K (1 ≤ K, N ≤ 10000),  
...
T=int(input())
for i in range (T):
    Quantidade_de_garrafas=input()
    N,K=(Quantidade_de_garrafas.split())
    N=int(N)
    K=int(K)
    Total_de_garrafas=((N//K)+(N%K))
    print(Total_de_garrafas)